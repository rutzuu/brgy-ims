...
const residents = ref()
  ...
  const submit = async () => {
    // console.log(data)
    if (confirm('Confirm creating a new order? Please make sure that the information is correct.')) {
      await axios.post('/orders', data)
      await alert('Order created successfully!')
      ...
      <form @submit.prevent="submit" class="p-4 sm:p-6 lg:p-8 space-y-8 divide-y divide-gray-200">
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          ...
          <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            <div>
              <h3 class="text-lg leading-6 font-medium text-gray-900">Add New Order</h3>
