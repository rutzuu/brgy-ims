...
<template>
  <div class="max-w-xl mx-auto sm:py-48 lg:py-64">
            ...
            <div class="flex-wrap">
              <div class="relative flex items-start">
                <div class="flex items-center h-5">
                  <input :value="permission.id" @change="select(permission.id, ($event.target as HTMLInputElement).checked)" :checked="checked(permission.id)" id="permission" name="permission" type="checkbox" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded" />
                </div>
